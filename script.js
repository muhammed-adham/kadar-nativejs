...
const navigationLinks = [
    ...
    { id: 'contact', label_en: 'Contact Us', label_ar: 'اتصل بنا', path: '#contact' },
...
`;
   ...
   ====================================================================== */
    ...
    `;
        ...
        mount.querySelectorAll('[data-mega-trigger]').forEach(el => {
            el.addEventListener('click', (e) => {
                e.preventDefault();
                const link = navigationLinks.find(l => l.id === el.getAttribute('data-mega-trigger'));
    ...
    `;
        ...
        document.getElementById('backToMobileMenuBtn').addEventListener('click', closeMegaMenu);
        document.getElementById('closeMegaMenuBtn').addEventListener('click', closeMobileMenu);
    }
...
function initializeHomePageSections() {
    ...
    if (categorySection) {
        ...
        const categorySlidesHtml = categories.map(cat => `
        ...
        <a href="#" class="category-card-link" onclick="setCurrentPage('${cat.page}', '${cat.categoryId}')">
            <div class="category-card">
                 ...
                 <ul class="category-card-details">
                    ${(getLabel(cat.variantsEn, cat.variantsAr)).map((variant, i) => `
